...
var card87 = new Card("<img src=\"images/Home/قلم-رصاص.jpg\">", "قلم-رصاص")
var card88 = new Card("<img src=\"images/Home/كُرْسِي.jpg\">", "كُرْسِي")
var card89 = new Card("<img src=\"images/Home/مطبخ.jfif\">", "مطبخ")
var card90 = new Card("<img src=\"images/Home/نافذة_شباك.jpg\">", "نافذة_شباك")
var card91 = new Card("<img src=\"images/Job\">", "Job")
var card92 = new Card("<img src=\"images/Job/جيش_عسكرية.jpeg\">", "جيش_عسكرية")
var card93 = new Card("<img src=\"images/Job/جُنْدِي.jpg\">", "جُنْدِي")
var card94 = new Card("<img src=\"images/Job/سكرتير_أمين_وزير.png\">", "سكرتير_أمين_وزير")
var card95 = new Card("<img src=\"images/Job/شرطة_(بُولِيس).jfif\">", "شرطة_(بُولِيس)")
var card96 = new Card("<img src=\"images/Job/شُغْل_عَمَل_مهنه.jfif\">", "شُغْل_عَمَل_مهنه")
var card97 = new Card("<img src=\"images/Job/صحافي_مراسل_(اعلامي).png\">", "صحافي_مراسل_(اعلامي)")
var card98 = new Card("<img src=\"images/Job/طبيب_حكيم_(دكتور).png\">", "طبيب_حكيم_(دكتور)")
var card99 = new Card("<img src=\"images/Job/طَالِب_تلميذ.png\">", "طَالِب_تلميذ")
var card100 = new Card("<img src=\"images/Job/فنان.jpg\">", "فنان")
var card101 = new Card("<img src=\"images/Job/مؤلف_كَاتِب_أَدِيب.jpg\">", "مؤلف_كَاتِب_أَدِيب")
var card102 = new Card("<img src=\"images/Job/مريض.png\">", "مريض")
var card103 = new Card("<img src=\"images/Job/ممثل.jpg\">", "ممثل")
var card104 = new Card("<img src=\"images/Job/مُحَامِي.png\">", "مُحَامِي")
var card105 = new Card("<img src=\"images/Job/مُدِير.png\">", "مُدِير")
var card106 = new Card("<img src=\"images/Job/مْعَلِّم_أستاذ.png\">", "مْعَلِّم_أستاذ")
var card107 = new Card("<img src=\"images/Job/نَادِل_(سفرجي).png\">", "نَادِل_(سفرجي)")
var card108 = new Card("<img src=\"images/Location\">", "Location")
var card109 = new Card("<img src=\"images/Location/أرض.jpg\">", "أرض")
var card110 = new Card("<img src=\"images/Location/الفضاء-الخارجي.jpg\">", "الفضاء-الخارجي")
var card111 = new Card("<img src=\"images/Location/بلدة.jpg\">", "بلدة")
var card112 = new Card("<img src=\"images/Location/بناية.jpeg\">", "بناية")
var card113 = new Card("<img src=\"images/Location/جامعة.jpg\">", "جامعة")
var card114 = new Card("<img src=\"images/Location/جسر_كوبري.jpg\">", "جسر_كوبري")
var card115 = new Card("<img src=\"images/Location/حانة_بار.jpg\">", "حانة_بار")
var card116 = new Card("<img src=\"images/Location/دكان_حانوت.jpg\">", "دكان_حانوت")
var card117 = new Card("<img src=\"images/Location/دولة.jpg\">", "دولة")
var card118 = new Card("<img src=\"images/Location/سكة_حديد.jpg\">", "سكة_حديد")
var card119 = new Card("<img src=\"images/Location/سوق.jpg\">", "سوق")
var card120 = new Card("<img src=\"images/Location/شارع.jpg\">", "شارع")
var card121 = new Card("<img src=\"images/Location/شقه.png\">", "شقه")
var card122 = new Card("<img src=\"images/Location/طريق.jpg\">", "طريق")
var card123 = new Card("<img src=\"images/Location/غرفة.png\">", "غرفة")
var card124 = new Card("<img src=\"images/Location/فندق_أوتيل_خان.jpg\">", "فندق_أوتيل_خان")
var card125 = new Card("<img src=\"images/Location/كنيسة.jfif\">", "كنيسة")
var card126 = new Card("<img src=\"images/Location/محطة-القطار.jpg\">", "محطة-القطار")
var card127 = new Card("<img src=\"images/Location/محكمة.png\">", "محكمة")
var card128 = new Card("<img src=\"images/Location/مخيم.jpg\">", "مخيم")
var card129 = new Card("<img src=\"images/Location/مدرسة.jpg\">", "مدرسة")
var card130 = new Card("<img src=\"images/Location/مدينة.jpg\">", "مدينة")
var card131 = new Card("<img src=\"images/Location/مزرعة.jpg\">", "مزرعة")
var card132 = new Card("<img src=\"images/Location/مستشفى.jpeg\">", "مستشفى")
var card133 = new Card("<img src=\"images/Location/مسرح.png\">", "مسرح")
var card134 = new Card("<img src=\"images/Location/مصرف_بنك.jpg\">", "مصرف_بنك")
var card135 = new Card("<img src=\"images/Location/مطار.jpg\">", "مطار")
var card136 = new Card("<img src=\"images/Location/مطعم.jpg\">", "مطعم")
var card137 = new Card("<img src=\"images/Location/مكتب.jpg\">", "مكتب")
var card138 = new Card("<img src=\"images/Location/مكتبة.jpg\">", "مكتبة")
var card139 = new Card("<img src=\"images/Location/منتزه.jpg\">", "منتزه")
var card140 = new Card("<img src=\"images/Location/منزل_بيت_دار_مسكن.jpg\">", "منزل_بيت_دار_مسكن")
var card141 = new Card("<img src=\"images/Location/موقع_مكان.jpg\">", "موقع_مكان")
var card142 = new Card("<img src=\"images/Location/ناد_ليلي.jpg\">", "ناد_ليلي")
var card143 = new Card("<img src=\"images/People\">", "People")
var card144 = new Card("<img src=\"images/People/أب_والد.png\">", "أب_والد")
var card145 = new Card("<img src=\"images/People/أم_والدة.png\">", "أم_والدة")
var card146 = new Card("<img src=\"images/People/إنسان_بشر_بني-آدم.jpg\">", "إنسان_بشر_بني-آدم")
var card147 = new Card("<img src=\"images/People/ابن.jpg\">", "ابن")
var card148 = new Card("<img src=\"images/People/ابنة.jpg\">", "ابنة")
var card149 = new Card("<img src=\"images/People/الآباء_الوالدان_الوالدون.png\">", "الآباء_الوالدان_الوالدون")
var card150 = new Card("<img src=\"images/People/الأبوين.png\">", "الأبوين")
var card151 = new Card("<img src=\"images/People/العاهل=_ملك_سلطان_أمير_خليفة.png\">", "العاهل=_ملك_سلطان_أمير_خليفة")
var card152 = new Card("<img src=\"images/People/امرأة_نساء.png\">", "امرأة_نساء")
var card153 = new Card("<img src=\"images/People/بنت_صبية_فتاة.jpg\">", "بنت_صبية_فتاة")
var card154 = new Card("<img src=\"images/People/جار.jfif\">", "جار")
var card155 = new Card("<img src=\"images/People/جد.png\">", "جد")
var card156 = new Card("<img src=\"images/People/جدة.png\">", "جدة")
var card157 = new Card("<img src=\"images/People/جمهور.jfif\">", "جمهور")
var card158 = new Card("<img src=\"images/People/رجل.png\">", "رجل")
var card159 = new Card("<img src=\"images/People/رَئِيس.jpg\">", "رَئِيس")
var card160 = new Card("<img src=\"images/People/زوج.png\">", "زوج")
var card161 = new Card("<img src=\"images/People/زوجة.png\">", "زوجة")
var card162 = new Card("<img src=\"images/People/شخص.jfif\">", "شخص")
var card163 = new Card("<img src=\"images/People/شقيق_اخ.png\">", "شقيق_اخ")
var card164 = new Card("<img src=\"images/People/شقيقة_اخت.png\">", "شقيقة_اخت")
var card165 = new Card("<img src=\"images/People/صديق_رفيق_(صَاحِب).jfif\">", "صديق_رفيق_(صَاحِب)")
var card166 = new Card("<img src=\"images/People/ضحية.png\">", "ضحية")
var card167 = new Card("<img src=\"images/People/طفل.png\">", "طفل")
var card168 = new Card("<img src=\"images/People/عائلة_عيلة_أسرة.jpg\">", "عائلة_عيلة_أسرة")
var card169 = new Card("<img src=\"images/People/لَاعِب_لَعِيب.jpg\">", "لَاعِب_لَعِيب")
var card170 = new Card("<img src=\"images/People/مشجع.jpg\">", "مشجع")
var card171 = new Card("<img src=\"images/People/وَلَد_صبي_فتى.jpg\">", "وَلَد_صبي_فتى")
var card172 = new Card("<img src=\"images/Society\">", "Society")
var card173 = new Card("<img src=\"images/Society/(فلوس_مَصَارِي)_مال.jpg\">", "(فلوس_مَصَارِي)_مال")
var card174 = new Card("<img src=\"images/Society/الطاقة-الخضراء.jpg\">", "الطاقة-الخضراء")
var card175 = new Card("<img src=\"images/Society/انتخاب_انتخابات.jpg\">", "انتخاب_انتخابات")
var card176 = new Card("<img src=\"images/Society/بندقية_(بارودة).jpg\">", "بندقية_(بارودة)")
var card177 = new Card("<img src=\"images/Society/جحيم_ جهنم.jpg\">", "جحيم_ جهنم")
var card178 = new Card("<img src=\"images/Society/جريدة_صحيفة.jpg\">", "جريدة_صحيفة")
var card179 = new Card("<img src=\"images/Society/جنة.jpg\">", "جنة")
var card180 = new Card("<img src=\"images/Society/جنس.png\">", "جنس")
var card181 = new Card("<img src=\"images/Society/حرب.jpg\">", "حرب")
var card182 = new Card("<img src=\"images/Society/دواء_طب.png\">", "دواء_طب")
var card183 = new Card("<img src=\"images/Society/دين.jpg\">", "دين")
var card184 = new Card("<img src=\"images/Society/رياضة.jpg\">", "رياضة")
var card185 = new Card("<img src=\"images/Society/سباق.jpg\">", "سباق")
var card186 = new Card("<img src=\"images/Society/سجن_حبس_محبس.jpg\">", "سجن_حبس_محبس")
var card187 = new Card("<img src=\"images/Society/سلام.jfif\">", "سلام")
var card188 = new Card("<img src=\"images/Society/سم.jfif\">", "سم")
var card189 = new Card("<img src=\"images/Society/سِعْر.png\">", "سِعْر")
var card190 = new Card("<img src=\"images/Society/طلب-زواج.png\">", "طلب-زواج")
var card191 = new Card("<img src=\"images/Society/عرس.jpg\">", "عرس")
var card192 = new Card("<img src=\"images/Society/عقد.jpg\">", "عقد")
var card193 = new Card("<img src=\"images/Society/علوم.jpg\">", "علوم")
var card194 = new Card("<img src=\"images/Society/عنصر_عرق.jpg\">", "عنصر_عرق")
var card195 = new Card("<img src=\"images/Society/فاتورة_(حساب).png\">", "فاتورة_(حساب)")
var card196 = new Card("<img src=\"images/Society/فَرِيق_مَجْمُوعَة_(فرقة).png\">", "فَرِيق_مَجْمُوعَة_(فرقة)")
var card197 = new Card("<img src=\"images/Society/قتل.jfif\">", "قتل")
var card198 = new Card("<img src=\"images/Society/كرة.png\">", "كرة")
var card199 = new Card("<img src=\"images/Society/لافتة.jpg\">", "لافتة")
var card200 = new Card("<img src=\"images/Society/لعبة.jpg\">", "لعبة")
var card201 = new Card("<img src=\"images/Society/مجلة.png\">", "مجلة")
var card202 = new Card("<img src=\"images/Society/مخدّرات.jpg\">", "مخدّرات")
var card203 = new Card("<img src=\"images/Society/مسدس.jpg\">", "مسدس")
var card204 = new Card("<img src=\"images/Society/موت.jpg\">", "موت")
var card205 = new Card("<img src=\"images/Society/مُبَارَاة.png\">", "مُبَارَاة")
var card206 = new Card("<img src=\"images/Society/هجوم_مهاجمة_مداهمة_حملة.jpg\">", "هجوم_مهاجمة_مداهمة_حملة")
var card207 = new Card("<img src=\"images/Transportation\">", "Transportation")
var card208 = new Card("<img src=\"images/Transportation/إطار-العجلة.jpg\">", "إطار-العجلة")
var card209 = new Card("<img src=\"images/Transportation/تذكرة.jpg\">", "تذكرة")
var card210 = new Card("<img src=\"images/Transportation/حافلة_ أتوبيس_ باص.jpg\">", "حافلة_ أتوبيس_ باص")
var card211 = new Card("<img src=\"images/Transportation/دراجة هوائية.png\">", "دراجة هوائية")
var card212 = new Card("<img src=\"images/Transportation/سفينة.jpg\">", "سفينة")
var card213 = new Card("<img src=\"images/Transportation/سيارة.jpg\">", "سيارة")
var card214 = new Card("<img src=\"images/Transportation/شاحنة.jpg\">", "شاحنة")
var card215 = new Card("<img src=\"images/Transportation/طائرة.jpg\">", "طائرة")
var card216 = new Card("<img src=\"images/Transportation/قارب.jpg\">", "قارب")
var card217 = new Card("<img src=\"images/Transportation/قطار.jpg\">", "قطار")
var card218 = new Card("<img src=\"images/Transportation/محرك.jpg\">", "محرك")
var card219 = new Card("<img src=\"images/Transportation/نقل_مواصلات.png\">", "نقل_مواصلات")
var card220 = new Card("<img src=\"images/Transportation/وقود.jpg\">", "وقود")

var myCards = [card1,card2,card3,card4,card5,card6,card7,card8,card9,card10,card11,card12,card13,card14,card15,card16,card17,card18,card19,card20,card21,card22,card23,card24,card25,card26,card27,card28,card29,card30,card31,card32,card33,card34,card35,card36,card37,card38,card39,card40,card41,card42,card43,card44,card45,card46,card47,card48,card49,card50,card51,card52,card53,card54,card55,card56,card57,card58,card59,card60,card61,card62,card63,card64,card65,card66,card67,card68,card69,card70,card71,card72,card73,card74,card75,card76,card77,card78,card79,card80,card81,card82,card83,card84,card85,card86,card87,card88,card89,card90,card91,card92,card93,card94,card95,card96,card97,card98,card99,card100,card101,card102,card103,card104,card105,card106,card107,card108,card109,card110,card111,card112,card113,card114,card115,card116,card117,card118,card119,card120,card121,card122,card123,card124,card125,card126,card127,card128,card129,card130,card131,card132,card133,card134,card135,card136,card137,card138,card139,card140,card141,card142,card143,card144,card145,card146,card147,card148,card149,card150,card151,card152,card153,card154,card155,card156,card157,card158,card159,card160,card161,card162,card163,card164,card165,card166,card167,card168,card169,card170,card171,card172,card173,card174,card175,card176,card177,card178,card179,card180,card181,card182,card183,card184,card185,card186,card187,card188,card189,card190,card191,card192,card193,card194,card195,card196,card197,card198,card199,card200,card201,card202,card203,card204,card205,card206,card207,card208,card209,card210,card211,card212,card213,card214,card215,card216,card217,card218,card219,card220];
var cardIndex = 0;
