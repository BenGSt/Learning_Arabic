...
var card206 = new Card("<img src=\"images/Nature/بُحِيرَة.jpg\">", "بُحِيرَة")
var card207 = new Card("<img src=\"images/Nature/تربة_(تْرَاب).jpg\">", "تربة_(تْرَاب)")
var card208 = new Card("<img src=\"images/Nature/تلّ_تَلِّة.jpg\">", "تلّ_تَلِّة")
var card209 = new Card("<img src=\"images/Nature/ثَلْج.jfif\">", "ثَلْج")
var card210 = new Card("<img src=\"images/Nature/جبل.jpg\">", "جبل")
var card211 = new Card("<img src=\"images/Nature/جزيرة.jpg\">", "جزيرة")
var card212 = new Card("<img src=\"images/Nature/جليد_ثلج.jpg\">", "جليد_ثلج")
var card213 = new Card("<img src=\"images/Nature/جِذْر_(شِرْش).jpg\">", "جِذْر_(شِرْش)")
var card214 = new Card("<img src=\"images/Nature/حرارة.jpg\">", "حرارة")
var card215 = new Card("<img src=\"images/Nature/رَمْل.jpeg\">", "رَمْل")
var card216 = new Card("<img src=\"images/Nature/رِيح.jpg\">", "رِيح")
var card217 = new Card("<img src=\"images/Nature/زَهْرَة.jpg\">", "زَهْرَة")
var card218 = new Card("<img src=\"images/Nature/سماء_(سَمَا).jpg\">", "سماء_(سَمَا)")
var card219 = new Card("<img src=\"images/Nature/شَاطِئ_(شَطّ).jpg\">", "شَاطِئ_(شَطّ)")
var card220 = new Card("<img src=\"images/Nature/شَجَرَة.jpg\">", "شَجَرَة")
var card221 = new Card("<img src=\"images/Nature/شَمْس.jpg\">", "شَمْس")
var card222 = new Card("<img src=\"images/Nature/طبيعة.png\">", "طبيعة")
var card223 = new Card("<img src=\"images/Nature/عُشْب.jpg\">", "عُشْب")
var card224 = new Card("<img src=\"images/Nature/غَابَة.jpg\">", "غَابَة")
var card225 = new Card("<img src=\"images/Nature/قَمَر.jpg\">", "قَمَر")
var card226 = new Card("<img src=\"images/Nature/كَوْكَب الأَرْض.jpg\">", "كَوْكَب الأَرْض")
var card227 = new Card("<img src=\"images/Nature/مَطَر_(شِتَى).jpeg\">", "مَطَر_(شِتَى)")
var card228 = new Card("<img src=\"images/Nature/مَوْجَة.jpg\">", "مَوْجَة")
var card229 = new Card("<img src=\"images/Nature/مُحِيط_المحيطات.jpg\">", "مُحِيط_المحيطات")
var card230 = new Card("<img src=\"images/Nature/نار_حريق.jpg\">", "نار_حريق")
var card231 = new Card("<img src=\"images/Nature/نجمة.jpg\">", "نجمة")
var card232 = new Card("<img src=\"images/Nature/نَبَات_(نبتة).jpg\">", "نَبَات_(نبتة)")
var card233 = new Card("<img src=\"images/Nature/نَهْر.jpg\">", "نَهْر")
var card234 = new Card("<img src=\"images/Nature/هَوَاء.jpg\">", "هَوَاء")
var card235 = new Card("<img src=\"images/Nature/واد_وادي_غور_(مَرْج).jpg\">", "واد_وادي_غور_(مَرْج)")
var card236 = new Card("<img src=\"images/Nature/ورقة.jpg\">", "ورقة")
var card237 = new Card("<img src=\"images/People/أب_والد.png\">", "أب_والد")
var card238 = new Card("<img src=\"images/People/أم_والدة.png\">", "أم_والدة")
var card239 = new Card("<img src=\"images/People/إنسان_بشر_بني-آدم.jpg\">", "إنسان_بشر_بني-آدم")
var card240 = new Card("<img src=\"images/People/ابن.jpg\">", "ابن")
var card241 = new Card("<img src=\"images/People/ابنة.jpg\">", "ابنة")
var card242 = new Card("<img src=\"images/People/الآباء_الوالدان_الوالدون.png\">", "الآباء_الوالدان_الوالدون")
var card243 = new Card("<img src=\"images/People/الأبوين.png\">", "الأبوين")
var card244 = new Card("<img src=\"images/People/العاهل=_ملك_سلطان_أمير_خليفة.png\">", "العاهل=_ملك_سلطان_أمير_خليفة")
var card245 = new Card("<img src=\"images/People/امرأة_نساء.png\">", "امرأة_نساء")
var card246 = new Card("<img src=\"images/People/بنت_صبية_فتاة.jpg\">", "بنت_صبية_فتاة")
var card247 = new Card("<img src=\"images/People/جار.jfif\">", "جار")
var card248 = new Card("<img src=\"images/People/جد.png\">", "جد")
var card249 = new Card("<img src=\"images/People/جدة.png\">", "جدة")
var card250 = new Card("<img src=\"images/People/جمهور.jfif\">", "جمهور")
var card251 = new Card("<img src=\"images/People/رجل.png\">", "رجل")
var card252 = new Card("<img src=\"images/People/رَئِيس.jpg\">", "رَئِيس")
var card253 = new Card("<img src=\"images/People/زوج.png\">", "زوج")
var card254 = new Card("<img src=\"images/People/زوجة.png\">", "زوجة")
var card255 = new Card("<img src=\"images/People/شخص.jfif\">", "شخص")
var card256 = new Card("<img src=\"images/People/شقيق_اخ.png\">", "شقيق_اخ")
var card257 = new Card("<img src=\"images/People/شقيقة_اخت.png\">", "شقيقة_اخت")
var card258 = new Card("<img src=\"images/People/صديق_رفيق_(صَاحِب).jfif\">", "صديق_رفيق_(صَاحِب)")
var card259 = new Card("<img src=\"images/People/ضحية.png\">", "ضحية")
var card260 = new Card("<img src=\"images/People/طفل.png\">", "طفل")
var card261 = new Card("<img src=\"images/People/عائلة_عيلة_أسرة.jpg\">", "عائلة_عيلة_أسرة")
var card262 = new Card("<img src=\"images/People/لَاعِب_لَعِيب.jpg\">", "لَاعِب_لَعِيب")
var card263 = new Card("<img src=\"images/People/مشجع.jpg\">", "مشجع")
var card264 = new Card("<img src=\"images/People/وَلَد_صبي_فتى.jpg\">", "وَلَد_صبي_فتى")
var card265 = new Card("<img src=\"images/Society/(فلوس_مَصَارِي)_مال.jpg\">", "(فلوس_مَصَارِي)_مال")
var card266 = new Card("<img src=\"images/Society/الطاقة-الخضراء.jpg\">", "الطاقة-الخضراء")
var card267 = new Card("<img src=\"images/Society/انتخاب_انتخابات.jpg\">", "انتخاب_انتخابات")
var card268 = new Card("<img src=\"images/Society/بندقية_(بارودة).jpg\">", "بندقية_(بارودة)")
var card269 = new Card("<img src=\"images/Society/جحيم_ جهنم.jpg\">", "جحيم_ جهنم")
var card270 = new Card("<img src=\"images/Society/جريدة_صحيفة.jpg\">", "جريدة_صحيفة")
var card271 = new Card("<img src=\"images/Society/جنة.jpg\">", "جنة")
var card272 = new Card("<img src=\"images/Society/جنس.png\">", "جنس")
var card273 = new Card("<img src=\"images/Society/حرب.jpg\">", "حرب")
var card274 = new Card("<img src=\"images/Society/دواء_طب.png\">", "دواء_طب")
var card275 = new Card("<img src=\"images/Society/دين.jpg\">", "دين")
var card276 = new Card("<img src=\"images/Society/رياضة.jpg\">", "رياضة")
var card277 = new Card("<img src=\"images/Society/سباق.jpg\">", "سباق")
var card278 = new Card("<img src=\"images/Society/سجن_حبس_محبس.jpg\">", "سجن_حبس_محبس")
var card279 = new Card("<img src=\"images/Society/سلام.jfif\">", "سلام")
var card280 = new Card("<img src=\"images/Society/سم.jfif\">", "سم")
var card281 = new Card("<img src=\"images/Society/سِعْر.png\">", "سِعْر")
var card282 = new Card("<img src=\"images/Society/طلب-زواج.png\">", "طلب-زواج")
var card283 = new Card("<img src=\"images/Society/عرس.jpg\">", "عرس")
var card284 = new Card("<img src=\"images/Society/عقد.jpg\">", "عقد")
var card285 = new Card("<img src=\"images/Society/علوم.jpg\">", "علوم")
var card286 = new Card("<img src=\"images/Society/عنصر_عرق.jpg\">", "عنصر_عرق")
var card287 = new Card("<img src=\"images/Society/فاتورة_(حساب).png\">", "فاتورة_(حساب)")
var card288 = new Card("<img src=\"images/Society/فَرِيق_مَجْمُوعَة_(فرقة).png\">", "فَرِيق_مَجْمُوعَة_(فرقة)")
var card289 = new Card("<img src=\"images/Society/قتل.jfif\">", "قتل")
var card290 = new Card("<img src=\"images/Society/كرة.png\">", "كرة")
var card291 = new Card("<img src=\"images/Society/لافتة.jpg\">", "لافتة")
var card292 = new Card("<img src=\"images/Society/لعبة.jpg\">", "لعبة")
var card293 = new Card("<img src=\"images/Society/مجلة.png\">", "مجلة")
var card294 = new Card("<img src=\"images/Society/مخدّرات.jpg\">", "مخدّرات")
var card295 = new Card("<img src=\"images/Society/مسدس.jpg\">", "مسدس")
var card296 = new Card("<img src=\"images/Society/موت.jpg\">", "موت")
var card297 = new Card("<img src=\"images/Society/مُبَارَاة.png\">", "مُبَارَاة")
var card298 = new Card("<img src=\"images/Society/هجوم_مهاجمة_مداهمة_حملة.jpg\">", "هجوم_مهاجمة_مداهمة_حملة")
var card299 = new Card("<img src=\"images/Transportation/إطار-العجلة.jpg\">", "إطار-العجلة")
var card300 = new Card("<img src=\"images/Transportation/تذكرة.jpg\">", "تذكرة")
var card301 = new Card("<img src=\"images/Transportation/حافلة_ أتوبيس_ باص.jpg\">", "حافلة_ أتوبيس_ باص")
var card302 = new Card("<img src=\"images/Transportation/دراجة هوائية.png\">", "دراجة هوائية")
var card303 = new Card("<img src=\"images/Transportation/سفينة.jpg\">", "سفينة")
var card304 = new Card("<img src=\"images/Transportation/سيارة.jpg\">", "سيارة")
var card305 = new Card("<img src=\"images/Transportation/شاحنة.jpg\">", "شاحنة")
var card306 = new Card("<img src=\"images/Transportation/طائرة.jpg\">", "طائرة")
var card307 = new Card("<img src=\"images/Transportation/قارب.jpg\">", "قارب")
var card308 = new Card("<img src=\"images/Transportation/قطار.jpg\">", "قطار")
var card309 = new Card("<img src=\"images/Transportation/محرك.jpg\">", "محرك")
var card310 = new Card("<img src=\"images/Transportation/نقل_مواصلات.png\">", "نقل_مواصلات")
var card311 = new Card("<img src=\"images/Transportation/وقود.jpg\">", "وقود")

var myCards = [card0,card1,card2,card3,card4,card5,card6,card7,card8,card9,card10,card11,card12,card13,card14,card15,card16,card17,card18,card19,card20,card21,card22,card23,card24,card25,card26,card27,card28,card29,card30,card31,card32,card33,card34,card35,card36,card37,card38,card39,card40,card41,card42,card43,card44,card45,card46,card47,card48,card49,card50,card51,card52,card53,card54,card55,card56,card57,card58,card59,card60,card61,card62,card63,card64,card65,card66,card67,card68,card69,card70,card71,card72,card73,card74,card75,card76,card77,card78,card79,card80,card81,card82,card83,card84,card85,card86,card87,card88,card89,card90,card91,card92,card93,card94,card95,card96,card97,card98,card99,card100,card101,card102,card103,card104,card105,card106,card107,card108,card109,card110,card111,card112,card113,card114,card115,card116,card117,card118,card119,card120,card121,card122,card123,card124,card125,card126,card127,card128,card129,card130,card131,card132,card133,card134,card135,card136,card137,card138,card139,card140,card141,card142,card143,card144,card145,card146,card147,card148,card149,card150,card151,card152,card153,card154,card155,card156,card157,card158,card159,card160,card161,card162,card163,card164,card165,card166,card167,card168,card169,card170,card171,card172,card173,card174,card175,card176,card177,card178,card179,card180,card181,card182,card183,card184,card185,card186,card187,card188,card189,card190,card191,card192,card193,card194,card195,card196,card197,card198,card199,card200,card201,card202,card203,card204,card205,card206,card207,card208,card209,card210,card211,card212,card213,card214,card215,card216,card217,card218,card219,card220,card221,card222,card223,card224,card225,card226,card227,card228,card229,card230,card231,card232,card233,card234,card235,card236,card237,card238,card239,card240,card241,card242,card243,card244,card245,card246,card247,card248,card249,card250,card251,card252,card253,card254,card255,card256,card257,card258,card259,card260,card261,card262,card263,card264,card265,card266,card267,card268,card269,card270,card271,card272,card273,card274,card275,card276,card277,card278,card279,card280,card281,card282,card283,card284,card285,card286,card287,card288,card289,card290,card291,card292,card293,card294,card295,card296,card297,card298,card299,card300,card301,card302,card303,card304,card305,card306,card307,card308,card309,card310,card311];
var cardIndex = 0;
