...
var card204 = new Card("<img src=\"images/Materials/أَلْمَاس_(ألماظ).jpg\">", "أَلْمَاس_(ألماظ)")
var card205 = new Card("<img src=\"images/Materials/حَجَر.jpg\">", "حَجَر")
var card206 = new Card("<img src=\"images/Materials/حَدِيد.jpg\">", "حَدِيد")
var card207 = new Card("<img src=\"images/Materials/حَطَب.jpg\">", "حَطَب")
var card208 = new Card("<img src=\"images/Materials/خَشَب.jpg\">", "خَشَب")
var card209 = new Card("<img src=\"images/Materials/ذَهَب.jpg\">", "ذَهَب")
var card210 = new Card("<img src=\"images/Materials/زُجَاج_(ق[ا]زاز).jpg\">", "زُجَاج_(ق[ا]زاز)")
var card211 = new Card("<img src=\"images/Materials/صخر.jpg\">", "صخر")
var card212 = new Card("<img src=\"images/Materials/صَّلْصَال_طِّين_غضار.jpg\">", "صَّلْصَال_طِّين_غضار")
var card213 = new Card("<img src=\"images/Materials/غُبَار_(غَبَرَة).jpg\">", "غُبَار_(غَبَرَة)")
var card214 = new Card("<img src=\"images/Materials/فضة_فِضَّة.jpg\">", "فضة_فِضَّة")
var card215 = new Card("<img src=\"images/Materials/مَعْدَن_فِلِزّ.jpg\">", "مَعْدَن_فِلِزّ")
var card216 = new Card("<img src=\"images/Materials/مَوَادّ_1-مادة.jpg\">", "مَوَادّ_1-مادة")
var card217 = new Card("<img src=\"images/Materials/نُحَاس_(نْحَاس).jpg\">", "نُحَاس_(نْحَاس)")
var card218 = new Card("<img src=\"images/Measurements/تَارِيخ.jpg\">", "تَارِيخ")
var card219 = new Card("<img src=\"images/Measurements/حافة.jpg\">", "حافة")
var card220 = new Card("<img src=\"images/Measurements/درجة-حرارة.jpg\">", "درجة-حرارة")
var card221 = new Card("<img src=\"images/Measurements/دَائِرَة.jpg\">", "دَائِرَة")
var card222 = new Card("<img src=\"images/Measurements/رُكْن_زَاوِيَة_(قُرنِة).jpg\">", "رُكْن_زَاوِيَة_(قُرنِة)")
var card223 = new Card("<img src=\"images/Measurements/سنتيمتر_(سنطي)‎.jpg\">", "سنتيمتر_(سنطي)‎")
var card224 = new Card("<img src=\"images/Measurements/كيلوغرام.jpg\">", "كيلوغرام")
var card225 = new Card("<img src=\"images/Measurements/مُرَبَّع‎.jpg\">", "مُرَبَّع‎")
var card226 = new Card("<img src=\"images/Measurements/مِتْر.jpg\">", "مِتْر")
var card227 = new Card("<img src=\"images/Measurements/نِصْف_نُصْف_(نصّ).jpg\">", "نِصْف_نُصْف_(نصّ)")
var card228 = new Card("<img src=\"images/Measurements/وَزْن.jpg\">", "وَزْن")
var card229 = new Card("<img src=\"images/Misc_Nouns/حرف[مُتَحَرِّك___سَاكِن]_يبدو[صَائِت___صَامِت].jpg\">", "حرف[مُتَحَرِّك___سَاكِن]_يبدو[صَائِت___صَامِت]")
var card230 = new Card("<img src=\"images/Misc_Nouns/خَرِيطَة_(خَارْطِة).jpg\">", "خَرِيطَة_(خَارْطِة)")
var card231 = new Card("<img src=\"images/Misc_Nouns/ضَوْء_نُور.jpg\">", "ضَوْء_نُور")
var card232 = new Card("<img src=\"images/Misc_Nouns/قِطْعَة-كيكة.jpg\">", "قِطْعَة-كيكة")
var card233 = new Card("<img src=\"images/Misc_Nouns/لا.jpg\">", "لا")
var card234 = new Card("<img src=\"images/Misc_Nouns/نعم_(ايوه_آه).jpg\">", "نعم_(ايوه_آه)")
var card235 = new Card("<img src=\"images/Misc_Nouns/نُقْطَة.jpg\">", "نُقْطَة")
var card236 = new Card("<img src=\"images/Nature/العالمية_(عَالَم_دنيا).jpg\">", "العالمية_(عَالَم_دنيا)")
var card237 = new Card("<img src=\"images/Nature/بَحَر.jpg\">", "بَحَر")
var card238 = new Card("<img src=\"images/Nature/بُحِيرَة.jpg\">", "بُحِيرَة")
var card239 = new Card("<img src=\"images/Nature/تربة_(تْرَاب).jpg\">", "تربة_(تْرَاب)")
var card240 = new Card("<img src=\"images/Nature/تلّ_تَلِّة.jpg\">", "تلّ_تَلِّة")
var card241 = new Card("<img src=\"images/Nature/ثَلْج.jfif\">", "ثَلْج")
var card242 = new Card("<img src=\"images/Nature/جبل.jpg\">", "جبل")
var card243 = new Card("<img src=\"images/Nature/جزيرة.jpg\">", "جزيرة")
var card244 = new Card("<img src=\"images/Nature/جليد_ثلج.jpg\">", "جليد_ثلج")
var card245 = new Card("<img src=\"images/Nature/جِذْر_(شِرْش).jpg\">", "جِذْر_(شِرْش)")
var card246 = new Card("<img src=\"images/Nature/حرارة.jpg\">", "حرارة")
var card247 = new Card("<img src=\"images/Nature/رَمْل.jpeg\">", "رَمْل")
var card248 = new Card("<img src=\"images/Nature/رِيح.jpg\">", "رِيح")
var card249 = new Card("<img src=\"images/Nature/زَهْرَة.jpg\">", "زَهْرَة")
var card250 = new Card("<img src=\"images/Nature/سماء_(سَمَا).jpg\">", "سماء_(سَمَا)")
var card251 = new Card("<img src=\"images/Nature/شَاطِئ_(شَطّ).jpg\">", "شَاطِئ_(شَطّ)")
var card252 = new Card("<img src=\"images/Nature/شَجَرَة.jpg\">", "شَجَرَة")
var card253 = new Card("<img src=\"images/Nature/شَمْس.jpg\">", "شَمْس")
var card254 = new Card("<img src=\"images/Nature/طبيعة.png\">", "طبيعة")
var card255 = new Card("<img src=\"images/Nature/عُشْب.jpg\">", "عُشْب")
var card256 = new Card("<img src=\"images/Nature/غَابَة.jpg\">", "غَابَة")
var card257 = new Card("<img src=\"images/Nature/قَمَر.jpg\">", "قَمَر")
var card258 = new Card("<img src=\"images/Nature/كَوْكَب الأَرْض.jpg\">", "كَوْكَب الأَرْض")
var card259 = new Card("<img src=\"images/Nature/مَطَر_(شِتَى).jpeg\">", "مَطَر_(شِتَى)")
var card260 = new Card("<img src=\"images/Nature/مَوْجَة.jpg\">", "مَوْجَة")
var card261 = new Card("<img src=\"images/Nature/مُحِيط_المحيطات.jpg\">", "مُحِيط_المحيطات")
var card262 = new Card("<img src=\"images/Nature/نار_حريق.jpg\">", "نار_حريق")
var card263 = new Card("<img src=\"images/Nature/نجمة.jpg\">", "نجمة")
var card264 = new Card("<img src=\"images/Nature/نَبَات_(نبتة).jpg\">", "نَبَات_(نبتة)")
var card265 = new Card("<img src=\"images/Nature/نَهْر.jpg\">", "نَهْر")
var card266 = new Card("<img src=\"images/Nature/هَوَاء.jpg\">", "هَوَاء")
var card267 = new Card("<img src=\"images/Nature/واد_وادي_غور_(مَرْج).jpg\">", "واد_وادي_غور_(مَرْج)")
var card268 = new Card("<img src=\"images/Nature/ورقة.jpg\">", "ورقة")
var card269 = new Card("<img src=\"images/People/أب_والد.png\">", "أب_والد")
var card270 = new Card("<img src=\"images/People/أم_والدة.png\">", "أم_والدة")
var card271 = new Card("<img src=\"images/People/إنسان_بشر_بني-آدم.jpg\">", "إنسان_بشر_بني-آدم")
var card272 = new Card("<img src=\"images/People/ابن.jpg\">", "ابن")
var card273 = new Card("<img src=\"images/People/ابنة.jpg\">", "ابنة")
var card274 = new Card("<img src=\"images/People/الآباء_الوالدان_الوالدون.png\">", "الآباء_الوالدان_الوالدون")
var card275 = new Card("<img src=\"images/People/الأبوين.png\">", "الأبوين")
var card276 = new Card("<img src=\"images/People/العاهل=_ملك_سلطان_أمير_خليفة.png\">", "العاهل=_ملك_سلطان_أمير_خليفة")
var card277 = new Card("<img src=\"images/People/امرأة_نساء.png\">", "امرأة_نساء")
var card278 = new Card("<img src=\"images/People/بنت_صبية_فتاة.jpg\">", "بنت_صبية_فتاة")
var card279 = new Card("<img src=\"images/People/جار.jfif\">", "جار")
var card280 = new Card("<img src=\"images/People/جد.png\">", "جد")
var card281 = new Card("<img src=\"images/People/جدة.png\">", "جدة")
var card282 = new Card("<img src=\"images/People/جمهور.jfif\">", "جمهور")
var card283 = new Card("<img src=\"images/People/رجل.png\">", "رجل")
var card284 = new Card("<img src=\"images/People/رَئِيس.jpg\">", "رَئِيس")
var card285 = new Card("<img src=\"images/People/زوج.png\">", "زوج")
var card286 = new Card("<img src=\"images/People/زوجة.png\">", "زوجة")
var card287 = new Card("<img src=\"images/People/شخص.jfif\">", "شخص")
var card288 = new Card("<img src=\"images/People/شقيق_اخ.png\">", "شقيق_اخ")
var card289 = new Card("<img src=\"images/People/شقيقة_اخت.png\">", "شقيقة_اخت")
var card290 = new Card("<img src=\"images/People/صديق_رفيق_(صَاحِب).jfif\">", "صديق_رفيق_(صَاحِب)")
var card291 = new Card("<img src=\"images/People/ضحية.png\">", "ضحية")
var card292 = new Card("<img src=\"images/People/طفل.png\">", "طفل")
var card293 = new Card("<img src=\"images/People/عائلة_عيلة_أسرة.jpg\">", "عائلة_عيلة_أسرة")
var card294 = new Card("<img src=\"images/People/لَاعِب_لَعِيب.jpg\">", "لَاعِب_لَعِيب")
var card295 = new Card("<img src=\"images/People/مشجع.jpg\">", "مشجع")
var card296 = new Card("<img src=\"images/People/وَلَد_صبي_فتى.jpg\">", "وَلَد_صبي_فتى")
var card297 = new Card("<img src=\"images/Society/(فلوس_مَصَارِي)_مال.jpg\">", "(فلوس_مَصَارِي)_مال")
var card298 = new Card("<img src=\"images/Society/الطاقة-الخضراء.jpg\">", "الطاقة-الخضراء")
var card299 = new Card("<img src=\"images/Society/انتخاب_انتخابات.jpg\">", "انتخاب_انتخابات")
var card300 = new Card("<img src=\"images/Society/بندقية_(بارودة).jpg\">", "بندقية_(بارودة)")
var card301 = new Card("<img src=\"images/Society/جحيم_ جهنم.jpg\">", "جحيم_ جهنم")
var card302 = new Card("<img src=\"images/Society/جريدة_صحيفة.jpg\">", "جريدة_صحيفة")
var card303 = new Card("<img src=\"images/Society/جنة.jpg\">", "جنة")
var card304 = new Card("<img src=\"images/Society/جنس.png\">", "جنس")
var card305 = new Card("<img src=\"images/Society/حرب.jpg\">", "حرب")
var card306 = new Card("<img src=\"images/Society/دواء_طب.png\">", "دواء_طب")
var card307 = new Card("<img src=\"images/Society/دين.jpg\">", "دين")
var card308 = new Card("<img src=\"images/Society/رياضة.jpg\">", "رياضة")
var card309 = new Card("<img src=\"images/Society/سباق.jpg\">", "سباق")
var card310 = new Card("<img src=\"images/Society/سجن_حبس_محبس.jpg\">", "سجن_حبس_محبس")
var card311 = new Card("<img src=\"images/Society/سلام.jfif\">", "سلام")
var card312 = new Card("<img src=\"images/Society/سم.jfif\">", "سم")
var card313 = new Card("<img src=\"images/Society/سِعْر.png\">", "سِعْر")
var card314 = new Card("<img src=\"images/Society/طلب-زواج.png\">", "طلب-زواج")
var card315 = new Card("<img src=\"images/Society/عرس.jpg\">", "عرس")
var card316 = new Card("<img src=\"images/Society/عقد.jpg\">", "عقد")
var card317 = new Card("<img src=\"images/Society/علوم.jpg\">", "علوم")
var card318 = new Card("<img src=\"images/Society/عنصر_عرق.jpg\">", "عنصر_عرق")
var card319 = new Card("<img src=\"images/Society/فاتورة_(حساب).png\">", "فاتورة_(حساب)")
var card320 = new Card("<img src=\"images/Society/فَرِيق_مَجْمُوعَة_(فرقة).png\">", "فَرِيق_مَجْمُوعَة_(فرقة)")
var card321 = new Card("<img src=\"images/Society/قتل.jfif\">", "قتل")
var card322 = new Card("<img src=\"images/Society/كرة.png\">", "كرة")
var card323 = new Card("<img src=\"images/Society/لافتة.jpg\">", "لافتة")
var card324 = new Card("<img src=\"images/Society/لعبة.jpg\">", "لعبة")
var card325 = new Card("<img src=\"images/Society/مجلة.png\">", "مجلة")
var card326 = new Card("<img src=\"images/Society/مخدّرات.jpg\">", "مخدّرات")
var card327 = new Card("<img src=\"images/Society/مسدس.jpg\">", "مسدس")
var card328 = new Card("<img src=\"images/Society/موت.jpg\">", "موت")
var card329 = new Card("<img src=\"images/Society/مُبَارَاة.png\">", "مُبَارَاة")
var card330 = new Card("<img src=\"images/Society/هجوم_مهاجمة_مداهمة_حملة.jpg\">", "هجوم_مهاجمة_مداهمة_حملة")
var card331 = new Card("<img src=\"images/Transportation/إطار-العجلة.jpg\">", "إطار-العجلة")
var card332 = new Card("<img src=\"images/Transportation/تذكرة.jpg\">", "تذكرة")
var card333 = new Card("<img src=\"images/Transportation/حافلة_ أتوبيس_ باص.jpg\">", "حافلة_ أتوبيس_ باص")
var card334 = new Card("<img src=\"images/Transportation/دراجة هوائية.png\">", "دراجة هوائية")
var card335 = new Card("<img src=\"images/Transportation/سفينة.jpg\">", "سفينة")
var card336 = new Card("<img src=\"images/Transportation/سيارة.jpg\">", "سيارة")
var card337 = new Card("<img src=\"images/Transportation/شاحنة.jpg\">", "شاحنة")
var card338 = new Card("<img src=\"images/Transportation/طائرة.jpg\">", "طائرة")
var card339 = new Card("<img src=\"images/Transportation/قارب.jpg\">", "قارب")
var card340 = new Card("<img src=\"images/Transportation/قطار.jpg\">", "قطار")
var card341 = new Card("<img src=\"images/Transportation/محرك.jpg\">", "محرك")
var card342 = new Card("<img src=\"images/Transportation/نقل_مواصلات.png\">", "نقل_مواصلات")
var card343 = new Card("<img src=\"images/Transportation/وقود.jpg\">", "وقود")
