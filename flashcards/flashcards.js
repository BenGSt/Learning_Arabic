...
var card118 = new Card("<img src=\"images/Society\">", "Society")
var card119 = new Card("<img src=\"images/Society/(فلوس_مَصَارِي)_مال.jpg\">", "(فلوس_مَصَارِي)_مال")
var card120 = new Card("<img src=\"images/Society/الطاقة-الخضراء.jpg\">", "الطاقة-الخضراء")
var card121 = new Card("<img src=\"images/Society/انتخاب_انتخابات.jpg\">", "انتخاب_انتخابات")
var card122 = new Card("<img src=\"images/Society/بندقية_(بارودة).jpg\">", "بندقية_(بارودة)")
var card123 = new Card("<img src=\"images/Society/جحيم_ جهنم.jpg\">", "جحيم_ جهنم")
var card124 = new Card("<img src=\"images/Society/جريدة_صحيفة.jpg\">", "جريدة_صحيفة")
var card125 = new Card("<img src=\"images/Society/جنة.jpg\">", "جنة")
var card126 = new Card("<img src=\"images/Society/جنس.png\">", "جنس")
var card127 = new Card("<img src=\"images/Society/حرب.jpg\">", "حرب")
var card128 = new Card("<img src=\"images/Society/دواء_طب.png\">", "دواء_طب")
var card129 = new Card("<img src=\"images/Society/دين.jpg\">", "دين")
var card130 = new Card("<img src=\"images/Society/رياضة.jpg\">", "رياضة")
var card131 = new Card("<img src=\"images/Society/سباق.jpg\">", "سباق")
var card132 = new Card("<img src=\"images/Society/سجن_حبس_محبس.jpg\">", "سجن_حبس_محبس")
var card133 = new Card("<img src=\"images/Society/سلام.jfif\">", "سلام")
var card134 = new Card("<img src=\"images/Society/سم.jfif\">", "سم")
var card135 = new Card("<img src=\"images/Society/سِعْر.png\">", "سِعْر")
var card136 = new Card("<img src=\"images/Society/طلب-زواج.png\">", "طلب-زواج")
var card137 = new Card("<img src=\"images/Society/عرس.jpg\">", "عرس")
var card138 = new Card("<img src=\"images/Society/عقد.jpg\">", "عقد")
var card139 = new Card("<img src=\"images/Society/علوم.jpg\">", "علوم")
var card140 = new Card("<img src=\"images/Society/عنصر_عرق.jpg\">", "عنصر_عرق")
var card141 = new Card("<img src=\"images/Society/فاتورة_(حساب).png\">", "فاتورة_(حساب)")
var card142 = new Card("<img src=\"images/Society/فَرِيق_مَجْمُوعَة_(فرقة).png\">", "فَرِيق_مَجْمُوعَة_(فرقة)")
var card143 = new Card("<img src=\"images/Society/قتل.jfif\">", "قتل")
var card144 = new Card("<img src=\"images/Society/كرة.png\">", "كرة")
var card145 = new Card("<img src=\"images/Society/لافتة.jpg\">", "لافتة")
var card146 = new Card("<img src=\"images/Society/لعبة.jpg\">", "لعبة")
var card147 = new Card("<img src=\"images/Society/مجلة.png\">", "مجلة")
var card148 = new Card("<img src=\"images/Society/مخدّرات.jpg\">", "مخدّرات")
var card149 = new Card("<img src=\"images/Society/مسدس.jpg\">", "مسدس")
var card150 = new Card("<img src=\"images/Society/موت.jpg\">", "موت")
var card151 = new Card("<img src=\"images/Society/مُبَارَاة.png\">", "مُبَارَاة")
var card152 = new Card("<img src=\"images/Society/هجوم_مهاجمة_مداهمة_حملة.jpg\">", "هجوم_مهاجمة_مداهمة_حملة")
var card153 = new Card("<img src=\"images/Transportation\">", "Transportation")
var card154 = new Card("<img src=\"images/Transportation/إطار-العجلة.jpg\">", "إطار-العجلة")
var card155 = new Card("<img src=\"images/Transportation/تذكرة.jpg\">", "تذكرة")
var card156 = new Card("<img src=\"images/Transportation/حافلة_ أتوبيس_ باص.jpg\">", "حافلة_ أتوبيس_ باص")
var card157 = new Card("<img src=\"images/Transportation/دراجة هوائية.png\">", "دراجة هوائية")
var card158 = new Card("<img src=\"images/Transportation/سفينة.jpg\">", "سفينة")
var card159 = new Card("<img src=\"images/Transportation/سيارة.jpg\">", "سيارة")
var card160 = new Card("<img src=\"images/Transportation/شاحنة.jpg\">", "شاحنة")
var card161 = new Card("<img src=\"images/Transportation/طائرة.jpg\">", "طائرة")
var card162 = new Card("<img src=\"images/Transportation/قارب.jpg\">", "قارب")
var card163 = new Card("<img src=\"images/Transportation/قطار.jpg\">", "قطار")
var card164 = new Card("<img src=\"images/Transportation/محرك.jpg\">", "محرك")
var card165 = new Card("<img src=\"images/Transportation/نقل_مواصلات.png\">", "نقل_مواصلات")
var card166 = new Card("<img src=\"images/Transportation/وقود.jpg\">", "وقود")

var myCards = [card1,card2,card3,card4,card5,card6,card7,card8,card9,card10,card11,card12,card13,card14,card15,card16,card17,card18,card19,card20,card21,card22,card23,card24,card25,card26,card27,card28,card29,card30,card31,card32,card33,card34,card35,card36,card37,card38,card39,card40,card41,card42,card43,card44,card45,card46,card47,card48,card49,card50,card51,card52,card53,card54,card55,card56,card57,card58,card59,card60,card61,card62,card63,card64,card65,card66,card67,card68,card69,card70,card71,card72,card73,card74,card75,card76,card77,card78,card79,card80,card81,card82,card83,card84,card85,card86,card87,card88,card89,card90,card91,card92,card93,card94,card95,card96,card97,card98,card99,card100,card101,card102,card103,card104,card105,card106,card107,card108,card109,card110,card111,card112,card113,card114,card115,card116,card117,card118,card119,card120,card121,card122,card123,card124,card125,card126,card127,card128,card129,card130,card131,card132,card133,card134,card135,card136,card137,card138,card139,card140,card141,card142,card143,card144,card145,card146,card147,card148,card149,card150,card151,card152,card153,card154,card155,card156,card157,card158,card159,card160,card161,card162,card163,card164,card165,card166];
var cardIndex = 0;
